...
//  NavHeaderScaleDemo
//
//  Created by 杜建超 on 16/4/27.
//  Copyright © 2016年 杜建超. All rights reserved.
//
...
- (void)viewDidLoad {
    ...
    self.headerImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"biaoshiIcon"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"杜建超出品：如何在导航条缩放头像"];
